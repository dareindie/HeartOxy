...
**Always seek guidance from a qualified healthcare professional for any health concerns. If you believe you are experiencing a medical emergency, contact local emergency services immediately.**
...
| Statement | Details |
|-----------|---------|
| **NOT a medical device** | This app is not designed, intended, or suitable for medical use |
| **NOT FDA approved** | This app has not been evaluated or approved by the FDA or any regulatory body |
| **NOT for diagnosis** | Do not use this app to diagnose any health condition |
| **NOT for treatment** | Do not use this app to guide treatment decisions |
| **NOT for emergencies** | In case of emergency, call local emergency services (911 in the US) |
